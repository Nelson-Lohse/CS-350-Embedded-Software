...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        if self.is_heat:
            if self.getFahrenheit() < self.setPoint:
                redLight.pulse()
            else:
                redLight.on()
        elif self.is_cool:
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if (altCounter < 6):
                ...
                ## degrees Fahrenheit.
                ## Remove this TODO comment block when complete.
                lcd_line_2 = f"Temp: {floor(self.getFahrenheit()):0.1f}F"
                print(f"Temp: {floor(self.getFahrenheit()):0.1f}F\n")
                ...
                print(f"{self.current_state.id}: {self.setPoint}F")
...
## Remove this TODO comment block when complete.
greenButton.when_pressed = TemperatureMachine.processTempStateButton()
...
## Remove this TODO comment block when complete.
redButton.when_pressed = TemperatureMachine.processTempIncButton()
...
## increase the setpoint by one degree Fahrenheit.
## Remove this TODO comment block when complete.
blueButton.when_pressed = TemperatureMachine.processTempDecButton()
